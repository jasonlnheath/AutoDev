#!/usr/bin/env python3
"""
Mal Step 7: Quote, Quasiquote, Cons, Concat

Step 7 adds:
- cons: add element to front of list/vector
- concat: concatenate lists/vectors
- vec: convert list to vector
- quote: return expression unevaluated (special form)
- quasiquote: mostly quoted, but unquote (~) and splice-unquote (~@) evaluate
- unquote: only works inside quasiquote
- splice-unquote: only works inside quasiquote, splices list
"""
...
def main():
    ...
    # Interactive mode
    print("Mal Step 7 - Quote, Quasiquote, Cons, Concat REPL")
